...
(*** testnet ***)
let ltctestnet () =
  ltc_oldest_to_consider := hexstring_hashval "57504f92b496f9f75bda43556a4dabe06deefa47315ba107a7f262b2f4b3651d";
  ltc_oldest_to_consider_time := 1512208339L;
  ltc_oldest_to_consider_height := 277422L
