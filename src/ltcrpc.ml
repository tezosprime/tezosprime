...
(*** testnet ***)
let ltctestnet () =
  ltc_oldest_to_consider := hexstring_hashval "51257c4e0154e305abdb5aeea65e5b7029daf90f80121be204807cb07263cb82";
  ltc_oldest_to_consider_time := 1522226815L;
  ltc_oldest_to_consider_height := 476444L
