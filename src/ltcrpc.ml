...
(*** testnet ***)
let ltctestnet () =
  ltc_oldest_to_consider := hexstring_hashval "f9670b601b5b167a5042e413b86078590bffda15a4c1a684a1a404f21fffe236";
  ltc_oldest_to_consider_time := 1514554868L;
  ltc_oldest_to_consider_height := 312735L
